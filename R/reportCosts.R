...
reportCosts <- function(gdx,output=NULL,regionSubsetList=NULL,t=c(seq(2005,2060,5),seq(2070,2110,10),2130,2150)) {
  ...
  tmp  <- mbind(tmp,setNames(cost + output[regi_on_gdx,,"Energy Investments|Pyrolysis (billion US$2017/yr)"], "Total Energy costs|Pyrolysis (billion US$2017/yr)"))
  ...
  tmp  <- mbind(tmp,setNames(cost1+cost2, "Operational costs|Biochar|Biomass|w/o CC (billion US$2017/yr)"))
