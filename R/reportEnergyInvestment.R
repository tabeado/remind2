...
reportEnergyInvestment <- function(gdx, regionSubsetList = NULL,
  ...
  # Biochar
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv),  "Energy Investments|Pyrolysis (billion US$2017/yr)"))
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", te = "biopyrOnly", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv), "Energy Investments|Pyrolysis|+|biopyrOnly (billion US$2017/yr)"))
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", te = "biopyrHeat", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv), "Energy Investments|Pyrolysis|+|biopyrHeat (billion US$2017/yr)"))
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", te = "biopyrElec", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv), "Energy Investments|Pyrolysis|+|biopyrElec (billion US$2017/yr)"))
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", te = "biopyrCHP", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv), "Energy Investments|Pyrolysis|+|biopyrCHP (billion US$2017/yr)"))
  tmp <- mbind(tmp, setNames(inv_se(ie = "pebiolc", te = "biopyrFuel", oe = "sebiochar", pe2se, adjte, v_directteinv, v_adjustteinv), "Energy Investments|Pyrolysis|+|biopyrFuel (billion US$2017/yr)"))
  ...
  - tmp[, , "Energy Investments|Electricity (billion US$2017/yr)"]
    ...
    - tmp[, , "Energy Investments|Pyrolysis (billion US$2017/yr)"]), # NEED TO CHECK WHETHER IT IS ALREADY ACCOUNTED FOR!
