...
reportSE <- function(gdx, regionSubsetList = NULL, t = c(seq(2005, 2060, 5), seq(2070, 2110, 10), 2130, 2150)) {
  ...
  tmp1 <- mbind(tmp1,
    ...
    se.prod(vm_prodSe, dataoc, oc2te, entySe, pebio, "seel", te = c("biopyrCHP"), 
    ...
    se.prod(vm_prodSe, dataoc, oc2te, entySe, pebio, "seel", te = setdiff(pe2se$all_te, c("bioigccc", "bioigcc", "biochp", "biopyrOnly","biopyrCHP","biopyrFuel")),
