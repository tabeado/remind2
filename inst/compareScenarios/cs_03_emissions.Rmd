...
# subtract 2020 values and convert to Gt
d <- d %>%
  left_join(
    d %>% filter(period == 2020),
...
pkBudg <- tribble(
      ...
      "World", 2020,    500,    "Emi|CO2|Cumulated|target|500 GtCO2 from",
      "World", 2020,    650,    "Emi|CO2|Cumulated|target|650 GtCO2 from",
      "World", 2020,    1000,   "Emi|CO2|Cumulated|target|1000 GtCO2 from",
 )

# show cumulated global emissions
showLinePlotsWithTarget(bind_rows(d, pkBudg), "Emi|CO2|Cumulated")
