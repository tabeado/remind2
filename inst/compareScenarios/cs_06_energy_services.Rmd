...
indicators_industry <- c(
  ...
  "Value Added|Industry|Chemicals|per-capita") # "Value Added|Industry|Other Industry|per-capita"
...
### Coupling to GDP
```{r plot per-capita indicators over per-capita GDP, results = 'asis'}
