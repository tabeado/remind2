...
showAreaAndBarPlots(
  data = data,
  vars = rev(c('SE|Biochar Mt|No co-product (Mt/yr)',
                'SE|Biochar Mt|Heat (Mt/yr)', 
                'SE|Biochar Mt|Electricity (Mt/yr)',
                'SE|Biochar Mt|Combined Heat and Power (Mt/yr)',
                'SE|Biochar Mt|Liquids (Mt/yr)')),
