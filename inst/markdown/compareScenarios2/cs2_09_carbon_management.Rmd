...
showAreaAndBarPlotsPlus(data, "Carbon Management|Carbon Capture|OAE calcination", scales = "fixed")
...
showAreaAndBarPlotsPlus(data, "Carbon Management|Storage|OAE calcination", scales = "fixed")
...
tot <- "Emi|CO2|CDR|OAE"
items <- c(
"Emi|CO2|CDR|OAE|Ocean Uptake",
"Emi|CO2|CDR|OAE|Calcination emissions"
)
