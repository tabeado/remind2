...
## Surplus convergence history

For each traded good, the worst residual market surplus until 2100 over iterations
(`p80_surplusMax_iter`) against its tolerance (dashed red, `p80_surplusMaxTolerance`).
Log y-axis: the good whose line stays above its tolerance longest is the one holding up
trade convergence. (Values that have reached exactly zero are dropped, as they cannot be
shown on a log scale.)

```{r conv_history, results = "asis", fig.height=6}
